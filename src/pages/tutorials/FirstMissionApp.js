  ...
  return (
    <>
      <div className="leftText wiki">
        ...
        <TutorialNote>
          <p>I am assuming that if you are here, you have already set up the kubos container by following the "<CustomLink to="/tutorials/docker-setup">Running docker-kubos</CustomLink>" tutorial.</p>
          <p>A basic familiarity with vscode, <CustomLink to="/github">git/github</CustomLink> and the <CustomLink to="/linuxtutorial">Linux terminal</CustomLink> is also expected.</p>
        </TutorialNote>
        ...
        <CodeBlock language={"bash"} code={`$ ./my-mission-app.py -c /home/kubos/.kubos/kubos/tools/local_config.toml\nSuccessfully pinged monitor service`} />
        ...
        <p>If we run our program, the output should look like this:</p>
        <CodeBlock language={"bash"} code={`./my-mission-app.py -c ~/.kubos/kubos/tools/local_config.toml\nSuccessfully pinged monitor service\nTelemetry insert completed successfully`} />
